...
export default function Home() {
  return (
    <>
      ...
      <main className={styles.main} data-spy="scroll" data-target=".navbar" data-offset="51">
      {/*!-- Navbar Start --*/}
    ...
    <div className="container-fluid bg-primary d-flex align-items-center mb-5 py-5" id="home" style={{minHeight: 100}}>
...
{/*<!-- Contact Start -->*/}    <div className="container-fluid py-5" id="contact">
        <div className="container">
            <div className="position-relative d-flex align-items-center justify-content-center">
...
required={true}                                    data-validation-required-message="Please enter your message"></textarea>
                                <p className="help-block text-danger"></p>
                            </div>
                            <div>
